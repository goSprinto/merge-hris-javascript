...
var AccountDetailsAndActionsIntegration = /*#__PURE__*/function () {
   ...
   */
  function AccountDetailsAndActionsIntegration(name, categories, color, slug, passthrough_available) {
  ...
  _createClass(AccountDetailsAndActionsIntegration, null, [{
    key: "initialize",
    value: function initialize(obj, name, categories, color, slug, passthrough_available) {
      obj['name'] = name;
