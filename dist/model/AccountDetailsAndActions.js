...
var AccountDetailsAndActions = /*#__PURE__*/function () {
   ...
   */
  function AccountDetailsAndActions(id, status, end_user_organization_name, end_user_email_address, webhook_listener_url) {
  ...
  _createClass(AccountDetailsAndActions, null, [{
    key: "initialize",
    value: function initialize(obj, id, status, end_user_organization_name, end_user_email_address, webhook_listener_url) {
      obj['id'] = id;
      obj['status'] = status;
