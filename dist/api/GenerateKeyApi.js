...
var GenerateKeyApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(GenerateKeyApi, [{
    ...
    value: function generateKeyCreate(generate_remote_key_request, callback) {
      var postBody = generate_remote_key_request; // verify the required parameter 'generate_remote_key_request' is set
