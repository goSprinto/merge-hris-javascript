...
var DeleteAccountApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(DeleteAccountApi, [{
    ...
    value: function deleteAccountCreate(x_account_token, callback) {
      var postBody = null; // verify the required parameter 'x_account_token' is set

      if (x_account_token === undefined || x_account_token === null) {
        throw new Error("Missing the required parameter 'x_account_token' when calling deleteAccountCreate");
      }
