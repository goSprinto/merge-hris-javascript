...
var RegenerateKeyApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(RegenerateKeyApi, [{
    ...
    value: function regenerateKeyCreate(remote_key_for_regeneration_request, callback) {
      var postBody = remote_key_for_regeneration_request; // verify the required parameter 'remote_key_for_regeneration_request' is set
