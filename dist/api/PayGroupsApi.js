...
var _PaginatedPayGroupList = _interopRequireDefault(require("../model/PaginatedPayGroupList"));
...
* @version 1.0
*/
var PayGroupsApi = /*#__PURE__*/function () {
  /**
  ...
  */
  function PayGroupsApi(apiClient) {
    _classCallCheck(this, PayGroupsApi);
  ...
  _createClass(PayGroupsApi, [{
    key: "payGroupsList",
    value: function payGroupsList(x_account_token, opts, callback) {
      opts = opts || {};
      ...
      var returnType = _PaginatedPayGroupList["default"];
      return this.apiClient.callApi('/pay-groups', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "payGroupsRetrieve",
    value: function payGroupsRetrieve(x_account_token, id, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'x_account_token' is set
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _PayGroup["default"];
      return this.apiClient.callApi('/pay-groups/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
  }]);
