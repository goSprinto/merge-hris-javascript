...
var LinkTokenApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(LinkTokenApi, [{
    key: "linkTokenCreate",
    value: function linkTokenCreate(end_user_details_request, callback) {
      var postBody = end_user_details_request; // verify the required parameter 'end_user_details_request' is set
